...
```
cd existing_repo
git remote add origin https://gitlab.com/nishant.k.io-group/iot-pipeline.git
git branch -M main
...
* [Set up project integrations](https://gitlab.com/nishant.k.io-group/iot-pipeline/-/settings/integrations)
