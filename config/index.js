...
module.exports = {
  ...
  producer: {
    maxBufferBytes: parseInt(process.env.KAFKA_MAX_BUFFER_BYTES || "10485760", 10), // 10MB default
    lingerMs: parseInt(process.env.KAFKA_LINGER_MS || "1000", 10), // 1 second default
  },
  emqx: {
